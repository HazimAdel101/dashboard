<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        {{-- <div class="sidebar" id="sidebar">
            <ul>
                <li><a href="#" onclick="toggleSubMenu('home')">Home</a></li>
                <ul class="submenu" id="homeSubmenu">
                    <li><a href="#">Dashboard</a></li>
                    <li><a href="#">Profile</a></li>
                </ul>
                <li><a href="#" onclick="toggleSubMenu('services')">Services</a></li>
                <ul class="submenu" id="servicesSubmenu">
                    <li><a href="#">Web Development</a></li>
                    <li><a href="#">Graphic Design</a></li>
                </ul>
                <li><a href="#" onclick="toggleSubMenu('about')">About Us</a></li>
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="#"
                    class="flex items-center justify-start p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a onclick="toggleDropdown()" href="#"
                    ...
                    <span class="flex-1 me-3 whitespace-nowrap">
                        <div class="flex justify-end"> كنبان</div>
                    </span>
